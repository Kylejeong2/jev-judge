...
export function Bench({
  ...
  return (
    <section className="relative">
      ...
      <div className="wood-dark relative mx-auto flex h-40 max-w-3xl items-end justify-center rounded-t-md px-6">
        <div className="absolute left-4 top-6 h-24 w-3 rounded-md bg-gradient-to-b from-red-800 via-white to-blue-900 opacity-80" />
        <div className="absolute right-4 top-6 h-24 w-3 rounded-md bg-gradient-to-b from-yellow-500 via-blue-900 to-yellow-500 opacity-80" />
        <div className="absolute inset-x-12 top-4 flex flex-col items-center gap-2">
          <Seal size={96} glow={busy} />
          <p className="font-serif text-[11px] text-oak-300/80">
      ...
      <div className="wood-rail mx-auto max-w-5xl rounded-b-md" />
